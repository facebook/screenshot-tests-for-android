...
The report will be saved in a generated temporary directory. The output directory can be changed using the `referenceDir` parameter. Tne directory will be created if it doesn't exist.
